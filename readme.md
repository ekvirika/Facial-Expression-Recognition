...
3. **ResNet50**
   - **Configuration**:
     ...
     - **Results**:
       ...
       - [Wandb: ResNet50 Configuration](https://wandb.ai/ellekvirikashvili-free-university-of-tbilisi-/facial-expression-recognition/runs/62mn0jg8?nw=nwuserellekvirikashvili)
       
![alt text](media/resnet50.png)
...
თუ გინდა, აქედან უფრო ჟღერადი ან პრეზენტაციისთვის ეფექტური ვერსია შეგირჩიო ✨ — გამაგებინე.
